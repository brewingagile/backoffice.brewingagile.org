...
public class DbUpgrader {
	public static MigrationsDescription piUpgradeDescription() {
		return migrations(
			...
			,migration("registration-invoice-method").installsThrough(script("029-registration-invoice-method.sql"))
			,migration("registration-invoice-2").installsThrough(script("030-registration-invoice-2.sql"))
		);
	}
